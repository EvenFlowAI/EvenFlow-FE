                                ...
                                <TableCell align="center">
                                    {data?.adminUserService
                                        ...
                                        : <RadioButtonUnchecked
                                            htmlColor="#DADADA"
                                            cursor="pointer"
                                            onClick={() => onChange("adminUserService", false)}/>}
                                </TableCell>
                                <TableCell align="center">
                                    {data?.adminUserService
                                        ? <RadioButtonChecked
                                        ...
                                        : <RadioButtonUnchecked
                                            htmlColor="#DADADA"
                                            cursor="pointer"
                                            onClick={() => onChange("adminUserService", true)}/>}
                                </TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell>Customer Self Service</TableCell>
                                <TableCell align="center">
                                    {data?.customerSelfService
                                        ? <RadioButtonChecked
                                            htmlColor="#3855F3"
                                            cursor="pointer"/>
                                        : <RadioButtonUnchecked
                                            htmlColor="#DADADA"
                                            cursor="pointer"
                                            onClick={() => onChange("customerSelfService", false)}/>}
                                </TableCell>
                                <TableCell align="center">
                                    {data?.customerSelfService
                                        ? <RadioButtonChecked
                                        ...
                                        : <RadioButtonUnchecked
                                            htmlColor="#DADADA"
                                            cursor="pointer"
                                            onClick={() => onChange("customerSelfService", true)}/>}
                                </TableCell>
                            </TableRow>
                        </TableBody>
                    </DemandTable>}
