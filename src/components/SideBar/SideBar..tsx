...
const AdminLinks: LinkType[] = [
    ...
    {to: Routes.Optimizer.Base, name: "Capacity Optimization", exact: true, roles: true},
    ...
    {to: Routes.Admin.Pricing, name: "Pricing", exact: true, roles: ["Owner", "Manager"]},
    {to: Routes.Admin.ServicePriceSettings, name: "Service Price Settings", exact: true, sub: true, roles: ["Owner", "Manager"]},
    {to: Routes.Admin.MobileService, name: "Mobile Service", exact: true, sub: true, roles: ["Owner", "Manager"]},
    {to: Routes.Admin.ServiceValet, name: "Service Valet", exact: true, sub: true, roles: ["Owner", "Manager"]},
    {to: Routes.BookingFlow.Base, name: "Booking Flow", roles: ["Owner", "Manager"]},
