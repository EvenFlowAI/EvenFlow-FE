...
const tableData: TableRowDataType<IAssignedServiceRequest>[] = [
  { header: "OP CODE", val: (el) => el.serviceRequest.code, align: "left" },
  {
    header: "DESCRIPTION",
    val: (el) =>
      el.serviceRequest.description ?? el.serviceRequestOverride?.description,
    align: "left",
  },
  {
    header: "PARTS UNIT COST",
    val: (el) =>
      `$${el.serviceRequestOverride?.partsUnitCost || el.serviceRequest.partsUnitCost}`,
    align: "left",
  },
  {
    header: "# OF PARTS",
    val: (el) =>
      `${el.serviceRequestOverride?.numberOfParts || el.serviceRequest.numberOfParts}`,
    align: "left",
  },
  {
    header: "PARTS AMOUNT",
  ...
  },
  {
    ...
    val: (el) =>
      `$${el.serviceRequestOverride?.invoiceAmount || el.serviceRequest.invoiceAmount}`,
    align: "left",
  },
];
