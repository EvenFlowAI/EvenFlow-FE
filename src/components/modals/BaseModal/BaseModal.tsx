...
export const BaseModal: React.FC<React.PropsWithChildren<DialogProps>> = props => {
...
export const DialogContent: React.FC<React.PropsWithChildren<DialogContentProps>> = props => {
    const classes = useStyles({maxWidth: 0});
    return <DC {...props} className={classes.dialogContent} />
}

export const DialogActions: React.FC<React.PropsWithChildren<DialogActionsProps>> = props => {
    const classes = useStyles({maxWidth: 0});
    return <DA {...props} className={classes.dialogActions} />
}

export const DialogTitle: React.FC<React.PropsWithChildren<DialogTitleProps & {onClose?: () => void}>> = ({children, onClose, ...props}) => {
    const classes = useStyles({maxWidth: 0});
    return (
