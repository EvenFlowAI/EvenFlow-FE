        ...
        {repairHistoryLoading ? (
          ...
          <div className={classes.wrapper}>
            <div className={classes.rightHeaderPart}>
              ...
              <Divider
                style={{ marginTop: 18, marginBottom: 24, padding: 0 }}
              />
            ...
            {repairHistory?.repairOrders
              .slice(0, (pageIndex + 1) * 2)
              .map((item) => (
                <div className={classes.orderWrapper} key={item.date}>
                  <div className={classes.orderMainData}>
                    <div className={classnames(classes.gridTableHead)}>
                      ...
                      >
                        {dayjs(item.date.split("T")[0]).format(
                          "dddd, MMMM DD, YYYY",
                        )}
                      </div>
                    </div>
                  ...
                  <div className={classes.orderMainData}>
                    <div className={classes.orderMainDataLeft}>
                      <div className={classes.orderMainDataLeftTop}>
                        <div className={classes.smallPadding}>
                          <div className={classes.titleNonUpperCase}>
                            RO Status:
                          </div>
                          <div>{item.status}</div>
                        </div>
                    ...
                    <div className={classes.orderMainDataRightTop}>
                      <div className={classes.smallPadding}>
                        ...
                        <div>
                          {item.warrantyPrice
                            ? `$${item.warrantyPrice.toFixed(2)} / $0.00`
                            : ""}{" "}
                        </div>
                      </div>
                      <div className={classes.smallPadding}>
                                ...
                                {service.labors.map((item) => {
                                  return (
                                    <li key={item.title}>
                                      <div>
                                        <span>
                                          [Tech {item.technicianDmsId}{" "}
                                          {item.technicianName}]
                                        </span>{" "}
                                        <span
                                          className={classes.titleNonUpperCase}
                                        >
                                          {item.title}
                                        </span>
                                      </div>
