...
import {Info, TPackage} from "../MaintenancePackage";
...
import ServiceRequestsMobile from "./ServiceRequestsMobile";
import TotalMaintenanceMobile from "./TotalMaintenanceMobile";
import IntervalUpsellsMobile from "./IntervalUpsellsMobile";
import ComplimentaryMobile from "./ComplimentaryMobile";
import TotalComplimentaryMobile from "./TotalComplimentaryMobile";
...
const MaintenancePackageMobile: React.FC<PackageSelectionMobileProps> = ({
                                                                           getTitle,
                                                                           data,
                                                                           isBmWService,
                                                                           withUpsells,
...
export default MaintenancePackageMobile;