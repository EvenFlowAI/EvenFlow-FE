...
const rowData: TableRowDataType<IDealershipGroupExtended>[] = [
  ...
  {
    val: (el) => el.countOfServiceCenters.toString(),
    header: "Service centers",
    align: "center",
  },
  {
    val: (el) => el.countOfEmployees.toString(),
    header: "Employees",
    align: "center",
  },
...
export const DealershipGroupsTable = () => {
  ...
  const [editedItem, setEditedItem] = useState<IDealershipGroupExtended | null>(
    null,
  );
