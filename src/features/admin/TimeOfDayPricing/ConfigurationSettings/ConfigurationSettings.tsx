...
export const ConfigurationSettings = () => {
  const { pricingLevels } = useSelector(
    (state: RootState) => state.pricingSettings,
  );
  const [editedItem, setEditedItem] = useState<IPricingLevel | undefined>(
    undefined,
  );
          ...
          <TableRow>
            ...
            <TableCell>
              <div className={classes.editCell}>
                ...
                <EditButton
                  onClick={handleOpen(EDemandCategory.Low)}
                  color="primary"
                >
                  Edit
                </EditButton>
          ...
          <TableRow>
            ...
            <TableCell>
              <div className={classes.editCell}>
                ...
                <EditButton
                  onClick={handleOpen(EDemandCategory.High)}
                  color="primary"
                >
                  Edit
                </EditButton>
