  ...
  return (
    <BaseModal {...props} width={450}>
          ...
          <Grid item xs={12}>
            <Autocomplete
              ...
              renderInput={autocompleteRender({
                label: "Select offer",
                error: formIsChecked && !form.offer,
              })}
            />
          </Grid>
          <Grid item xs={12}>
            <Autocomplete
              options={Object.values(EAudience).filter(
                (v) => !isNaN(Number(v)),
              )}
              ...
              renderInput={autocompleteRender({
                label: "Audience",
                error: formIsChecked && !form.audience,
              })}
            />
          </Grid>
          <Grid item xs={12}>
      ...
      <DialogActions>
        ...
        <LoadingButton color="primary" onClick={handleSend} variant="contained">
          Send Offer
        </LoadingButton>
      </DialogActions>
    </BaseModal>
