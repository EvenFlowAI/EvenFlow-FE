...
const BaseScheduleByEmployee = () => {
  const { employeeRoleHours, loading } = useSelector(
  ...
  const { isLoading: hoursIsLoading } = useSelector(
  ...
  const [currentEmployee, setCurrentEmployee] =
    useState<IEmployeeRoleHours | null>(null);
