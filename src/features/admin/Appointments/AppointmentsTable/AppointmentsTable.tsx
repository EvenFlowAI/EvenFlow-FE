...
export const AppointmentsTable: React.FC<TAppointmentsTable> = ({
  ...
  const { appointments, count } = useSelector(
  ...
  const handleOpen =
    (el: IAppointment) => (e: React.MouseEvent<HTMLElement, MouseEvent>) => {
  ...
  return appointments.length ? (
    <>
      <Table<IAppointment>
        ...
        isLoading={isLoading}
        rowData={AppointmentsColumns.filter((col) =>
          selectedColumns.includes(col.header.toString()),
        )}
