...
export const DemandSegmentsDesirability = () => {
  ...
  const handleChange =
    (idx: number, name: keyof TForm) => (e: any, val: number | number[]) => {
      const f = [...form];
      const r = { ...form[idx] };
      ...
      {isLoading ? (
        ...
        <StyledTable className={classes.table}>
          <TableHead>
            ...
            <TableRow>
              <TableCell className={classes.subtitleCell}>
                Segment Start
              </TableCell>
              <TableCell className={classes.subtitleCell}>
                Segment End
