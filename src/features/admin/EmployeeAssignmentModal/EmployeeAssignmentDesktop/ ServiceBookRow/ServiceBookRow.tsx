...
const ServiceBookRow: React.FC<TProps> = ({ item, onMethodChange }) => {
  ...
  return (
    <TableRow key={item.serviceBookId ?? item.serviceBookName}>
      <TableCell key="name" style={{ borderRight: "1px solid #DADADA" }}>
      ...
      <TCellData key="advisors">
        <SelectsWrapper>
          <div key="advisor">
            <Autocomplete
              ...
              value={advisorOptions.find(
                (el) => el.value === advisorPrimaryMethod,
              )}
          ...
          <div
            style={{
              backgroundColor: isAdvisorSecondaryDisabled ? "#DADADA" : "",
            }}
            key="technician"
          >
            <Autocomplete
              ...
              value={
                methodOptions.find(
                  (el) => el.value === advisorSecondaryMethod,
                ) ?? null
              }
              onChange={onMethodChange(
                item,
      ...
      <TCellData key="technicians">
        <SelectsWrapper>
          ...
          <div
            style={{
              backgroundColor: isTechSecondaryDisabled ? "#DADADA" : "",
            }}
            key="technician"
          >
            <Autocomplete
