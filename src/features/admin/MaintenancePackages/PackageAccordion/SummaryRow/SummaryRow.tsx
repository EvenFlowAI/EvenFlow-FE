...
const SummaryRow: React.FC<
  React.PropsWithChildren<React.PropsWithChildren<TSummaryProps>>
> = ({
  isComplimentary,
  ...
  const onChange = (value: string, item: TSummaryCell): void => {
    if (item.fieldName && onInputChange)
      onInputChange(value, item.fieldName, item.optionType);
  };
