...
const OrderIndexModal: React.FC<
  React.PropsWithChildren<React.PropsWithChildren<TOrderIndexProps>>
> = ({ onClose, open }) => {
  ...
  const onComplimentaryOrderChange =
    (id: number) => (e: React.ChangeEvent<HTMLInputElement>) => {
      e.persist();
  ...
  return (
    <BaseModal open={open} onClose={onCancel}>
      <DialogTitle onClose={onCancel}>
        Add Index To Maintenance Package's Op Codes
      </DialogTitle>
      {isPackageLoading ? (
        <Loading />
      ) : (
