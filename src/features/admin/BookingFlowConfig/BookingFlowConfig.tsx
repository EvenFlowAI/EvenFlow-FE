...
export const BookingFlowConfig = () => {
  ...
  const isValid = (optionType: keyof TServiceTypeSettings): boolean => {
    if (
      (optionType === "checkRecallsExisting" ||
        optionType === "checkRecallsNew") &&
      !selectedSC?.recallServiceRequestId
    ) {
      showError(
        "To enable Checking Recalls you need to select Default Recall Op Code",
      );
      return false;
    }
  ...
  const onCheck =
    ...
    (e: React.ChangeEvent<HTMLInputElement>, checked: boolean) => {
      if (isValid(optionType)) {
        ...
        const currentServiceType = configuration.find(
          ...
          if (
            ...
            setConfiguration((prev) => {
              const filtered = prev.filter(
                (el) => el.serviceType !== serviceType,
              );
              return [...filtered, updated];
            });
          }
          if (
            optionType === "valueService" ||
            optionType === "productPageForValueService"
          ) {
            if (currentServiceType?.serviceType === EServiceType.VisitCenter) {
              ...
              currentServiceType.serviceType === EServiceType.PickUpDropOff
            ) {
              analogServiceType = configuration.find(
                (item) => item.serviceType === EServiceType.VisitCenter,
              );
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    <Switch
                      ...
                      checked={Boolean(
                        visitCenterConfig?.productPageForValueService,
                      )}
                      color="primary"
                    />
                  </TableCell>
                  <TableCell align="center">
                    <Switch
                      ...
                      disabled={
                        !mobileServiceConfig?.valueService ||
                        !mobileServiceConfig?.available
                      }
                      checked={Boolean(
                        mobileServiceConfig?.productPageForValueService,
                      )}
                      color="primary"
                    />
                  </TableCell>
                  <TableCell align="center">
                    <Switch
                      ...
                      disabled={
                        !pickUpDropOffConfig?.valueService ||
                        !pickUpDropOffConfig?.available
                      }
                      checked={Boolean(
                        pickUpDropOffConfig?.productPageForValueService,
                      )}
                      color="primary"
                    />
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    <Switch
                      ...
                      checked={Boolean(
                        mobileServiceConfig?.appointmentSelection,
                      )}
                      color="primary"
                    />
                  </TableCell>
                  <TableCell align="center">
                    <Switch
                      ...
                      checked={Boolean(
                        pickUpDropOffConfig?.appointmentSelection,
                      )}
                      disabled={!pickUpDropOffConfig?.available}
                      color="primary"
                    />
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    <Switch
                      ...
                      checked={Boolean(
                        mobileServiceConfig?.transportationNeeds,
                      )}
                      color="primary"
                    />
                  </TableCell>
                  <TableCell align="center">
                    <Switch
                      ...
                      checked={Boolean(
                        pickUpDropOffConfig?.transportationNeeds,
                      )}
                      disabled
                      color="primary"
                    />
