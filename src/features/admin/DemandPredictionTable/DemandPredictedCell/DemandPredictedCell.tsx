...
export const DemandPredictedCell: React.FC<{ item: IDemandPrediction }> = ({
  item,
}) => {
  const { settings } = useSelector(
    (state: RootState) => state.demandManagement,
  );
    ...
    >
      ...
      >
        ...
        <LinksWrapper>
          <LabelLink
            subText={
              predictedMethod?.isConfigured ? "Configured" : "Not Configured"
            }
          ...
          <LabelLink
            subText={
              probabilityMethod?.isConfigured ? "Configured" : "Not Configured"
            }
            color={probabilityMethod?.isConfigured ? "#7898FF" : "#C71062"}
            icon={
              probabilityMethod?.isConfigured ? <CheckIcon /> : <RedCross />
            }
