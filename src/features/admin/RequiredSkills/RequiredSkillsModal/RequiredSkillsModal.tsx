...
export const RequiredSkillsModal: React.FC<
    ...
    <BaseModal {...props} maxWidth="xs">
      ...
      <DialogContent>
        ...
        <TextField
          ...
          label="Description"
          value={
            payload?.serviceRequestOverride?.description || payload?.serviceRequest.description
          }
        />
        <FormGroup>
          <FormControlLabel
      ...
      <DialogActions>
        ...
        <LoadingButton loading={loading} color="primary" variant="contained" onClick={handleSave}>
          Save
        </LoadingButton>
      </DialogActions>
    </BaseModal>
