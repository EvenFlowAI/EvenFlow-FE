            ...
            <TableRow>
              ...
              <TableCell className={classes.switchCell}>
                ...
                <Switch
                  ...
                  checked={Boolean(
                    mappedTW[EWindowType.Window1]?.isEligibility,
                  )}
                  color="primary"
                />
                <strong>ON</strong>
              ...
              <TableCell className={classes.switchCell}>
                ...
                <Switch
                  ...
                  checked={Boolean(
                    mappedTW[EWindowType.Window2]?.isEligibility,
                  )}
                  color="primary"
                />
                <strong>ON</strong>
              ...
              <TableCell className={classes.switchCell}>
                ...
                <Switch
                  ...
                  checked={Boolean(
                    mappedTW[EWindowType.Window3]?.isEligibility,
                  )}
                  color="primary"
                />
                <strong>ON</strong>
