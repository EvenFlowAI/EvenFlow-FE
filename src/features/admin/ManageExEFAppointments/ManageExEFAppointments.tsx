...
const ManageExEFAppointments = () => {
  ...
  return (
    <div style={{ width: "100%" }}>
      <TitleContainer
        title="Manage Ex EvenFlow Appointments"
        pad
        parent={capacityManagementRoot}
      />
      <SquarePaper variant="outlined" style={{ padding: 20 }}>
        <p className={classes.text}>
          By switching off, the EvenFlow app will no longer flag appointments as
          "Main Drive" or "Express Service". This feature is only for
          appointments made outside of EvenFlow through some other booking
          channel.
        </p>
