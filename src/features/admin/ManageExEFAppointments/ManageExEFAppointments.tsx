    ...
    <div style={{ width: '100%' }}>
      ...
      <SquarePaper variant="outlined" style={{ padding: 20 }}>
        <p className={classes.text}>
          By switching off, the EvenFlow app will no longer flag appointments as "Main Drive" or
          "Express Service". This feature is only for appointments made outside of EvenFlow through
          some other booking channel.
        </p>
        <div className={classes.switchWrapper}>
          <p className={classes.label}>Flag Appointments as Main Drive or Express Service</p>
          <Switch
        ...
        <div className={classes.actionsWrapper}>
          <div className={classes.buttonsWrapper}>
            <Button disabled={remindersLoading} onClick={onCancel} className={classes.cancelButton}>
              Cancel
            </Button>
            <Button onClick={onSave} disabled={remindersLoading} className={classes.saveButton}>
              Save
            </Button>
          </div>
        </div>
