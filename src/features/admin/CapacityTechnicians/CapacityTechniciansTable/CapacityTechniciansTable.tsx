...
const CapacityTechniciansTable: React.FC<{ selectedTab: string }> = ({
  selectedTab,
}) => {
  ...
  const DaysData: TableRowDataType<ITechnicianCapacity>[] = daysOfWeek.map(
    (day) => ({
  ...
  const RowData: TableRowDataType<ITechnicianCapacity>[] = [
    ...
    },
    {
      ...
      val: (el) =>
        el.avarageBillHoursPerRO ? el.avarageBillHoursPerRO.toString() : "",
      width: 130,
    },
    {
      header: "Efficiency",
