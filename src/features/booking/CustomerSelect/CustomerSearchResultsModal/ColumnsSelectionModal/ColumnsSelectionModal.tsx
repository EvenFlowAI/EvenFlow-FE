...
const ColumnsSelectionModal: React.FC<
  React.PropsWithChildren<React.PropsWithChildren<DialogProps & TProps>>
> = ({ onClose, open, selectedColumns, setSelectedColumns }) => {
  ...
  return (
    <BaseModal onClose={onCancel} open={open} width={550}>
      <DialogTitle style={{ textAlign: "left" }} onClose={onCancel}>
      ...
      <DialogContent>
        <div className={classes.wrapper}>
          <FormControlLabel
            ...
            control={
              checkedColumns.length === customerDataColumns.length ? (
