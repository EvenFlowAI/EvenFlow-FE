                ...
                {data.servicesCompleted.map((service, i) => {
                    ...
                    return <TableRow key={i.toString()}>
                        <TableCell key="index" align="center"
                                   className={lastRow ? classes.lastRowCell : classes.cell}>{indexes[i]}</TableCell>
                        <TableCell key={service.name}
                                   className={lastRow ? classes.lastRowCell : classes.cell}>{service.name}</TableCell>
                        <TableCell key="parts" align="center"
                                   className={lastRow ? classes.lastRowCell : classes.cell}>${service.parts.toFixed(2)}</TableCell>
                        <TableCell key="labor" align="center"
                                   className={lastRow ? classes.lastRowCell : classes.cell}>${service.labor.toFixed(2)}</TableCell>
                        <TableCell key="total" align="center"
                                   className={lastRow ? classes.lastRowCell : classes.cell}>${service.total.toFixed(2)}</TableCell>
                    </TableRow>
                })}
