...
const PackagesTotalComplimentary: React.FC<
  React.PropsWithChildren<React.PropsWithChildren<TTotalComplimentaryProps>>
> = ({ isBmWService, packages, setClasses, handleClick }) => {
  ...
  return (
    <React.Fragment>
      <div
        className="totalComplimentary complimentaryTitle"
