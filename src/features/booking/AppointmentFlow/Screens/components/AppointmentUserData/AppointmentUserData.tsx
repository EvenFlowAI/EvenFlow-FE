...
> = ({ errors, setErrors, isEmailRequired }) => {
  ...
  const { customer, userType } = useSelector(
  ...
  useEffect(() => {
    if (customerLoadedData) {
      const data: ICustomer = {
        ...
        email: customerLoadedData?.emails?.length
          ? customerLoadedData.emails[0]
          : "",
    ...
    <Wrapper>
      ...
      {companyNameIsOn ? (
        <TextField
          ...
          disabled={
            ...
            Boolean(customerLoadedData?.companyName?.length)
          }
          name="companyName"
          fullWidth
      ...
      <TextField
        ...
        disabled={
          ...
          !!customerLoadedData?.phoneNumbers.length
        }
        name="phoneNumber"
        fullWidth
