...
> = ({ onChangeSlot }) => {
  ...
  const [serviceValetTime, setServiceValetTime] =
    useState<TServiceValetSlot | null>(null);
  ...
  const waitListData = appointment
    ? waitListSettings
    : appointmentByKey?.waitlistTextSettings;
        ...
        <div>
          <div>
            ...
            <span>
              {" "}
              {dayjs
                .utc(serviceValetTime?.pickUpMin, "HH:mm:ss")
                .format("hh:mm A")}
            </span>
            <span> {t("to")} </span>
            <span>
              {" "}
              {dayjs
                .utc(serviceValetTime?.pickUpMax, "HH:mm:ss")
                .format("hh:mm A")}
            </span>
          </div>
          ...
          serviceValetTime?.dropOffMax ? (
            <div>
              ...
              <span>
                {" "}
                {dayjs
                  .utc(serviceValetTime?.dropOffMin, "HH:mm:ss")
                  .format("hh:mm A")}
              </span>
              <span> {t("to")} </span>
              <span>
                {" "}
                {dayjs
                  .utc(serviceValetTime?.dropOffMax, "HH:mm:ss")
                  .format("hh:mm A")}
              </span>
            </div>
          ) : null}
