...
export class Api {
  static endpoints: IApiEndpoints = {
    ...
    AncillaryPricing: {
      GetZones: {
        route: "/ancillary-price/geographic-zone/by-query",
        method: "post",
      },
      UpdateZone: {
        route: "/ancillary-price/geographic-zone/{id}",
        method: "put",
      },
      GetDistances: {
        route: "/ancillary-price/distance/by-query",
        method: "post",
      },
      CreateDistance: { route: "/ancillary-price/distance", method: "post" },
      UpdateDistance: {
        route: "/ancillary-price/distance/{id}",
        method: "put",
      },
      DeleteDistance: {
        route: "/ancillary-price/distance/{id}",
      ...
      GetByZip: {
        route: "/ancillary-price/get-convenience-fee",
        method: "post",
      },
    },
    Appointments: {
      ...
      CheckPodChanged: {
        route: "/appointments/{key}/check-pod-changed",
        method: "post",
      },
      GetServiceBooks: {
        route: "/appointments-filter/{id}/service-book-list",
        method: "get",
      },
      GetSchedulers: {
        route: "/appointments-filter/scheduler-list",
        method: "get",
      },
    },
    AppointmentAllocation: {
      SetTimeWindows: {
        route: "/appointment-allocations/time-windows",
        method: "put",
      },
      GetTimeWindows: {
        route: "/appointment-allocations/time-windows",
      ...
      SetUnplanned: {
        route: "/appointment-allocations/unplanned-demand-segments",
        method: "put",
      },
      GetUnplanned: {
        route: "/appointment-allocations/unplanned-demand-segments",
    ...
    AppointmentSlots: {
      ...
      GetServiceValetSlots: {
        route: "/service-valet-appointment-slots/by-query",
        method: "post",
      },
    },
    AppointmentPricing: {
      GetPriceList: {
        route: "/appointment-pricing/requests-price-list",
        method: "post",
      },
    },
    Authentications: {
    ...
    CapacityManagement: {
      Reallocate: {
        route: "/capacity-management/capacity-data-reallocate",
        method: "put",
      },
    },
    CapacitySettings: {
    ...
    ComplimentaryServices: {
      ...
      AddFromList: {
        route: "/complimentary-services/add-service-request",
        method: "post",
      },
    ...
    Customers: {
      GetByName: {
        route: "/customers/vehicles/by-customer-name",
        method: "get",
      },
      Update: { route: "/customers/vehicles", method: "put" },
      GetRepairHistory: {
        route: "/customers/vehicles/repair-orders",
        method: "get",
      },
      GetBySearchTerm: { route: "/customers/vehicles", method: "get" },
      GetSingleCustomerVehicles: {
        route: "/customers/single-customer-vehicles",
        method: "get",
      },
    },
    CustomerConsent: {
    ...
    Employees: {
      ...
      UpdateAssignmentSettings: {
        route: "/employees/assignment-settings",
        method: "put",
      },
    },
    EmployeeCapacity: {
      GetAdvisorsCapacity: {
        route: "/employee-capacity/advisors",
        method: "get",
      },
      ...
      GetTechniciansCapacity: {
        route: "/employee-capacity/technicians",
        method: "get",
      },
    ...
    EmployeeSchedule: {
      ...
      UpdateByDate: {
        route: "/employee-schedules/set-for-date-range",
        method: "put",
      },
      GetBaseSummary: {
        route: "/employee-schedules/base-summary",
        method: "post",
      },
    ...
    GeographicZones: {
      ...
      ReassignZipCode: {
        route: "/geographic-zones/re-assign-zip-code/{id}",
        method: "put",
      },
      RemoveZipCode: {
        route: "/geographic-zones/zip-code/{id}",
        method: "delete",
      },
    ...
    GlobalVehicles: {
      ...
      GetMakesStatistic: {
        route: "/global-vehicle-makes/statistics",
        method: "get",
      },
      GetModelsStatistic: {
        route: "/global-vehicle-models/statistics",
        method: "get",
      },
    },
    IntervalUpsell: {
    ...
    MaintenancePackages: {
      ...
      PackageOptions: {
        route: "/maintenance-packages/{id}/options",
        method: "put",
      },
      ByVehicle: { route: "/maintenance-packages/by-vehicle", method: "post" },
      GetShortByQuery: {
        route: "/maintenance-packages/short-by-query",
        method: "post",
      },
      GetOptionsByQuery: {
        route: "/maintenance-packages/options-by-query",
        method: "post",
      },
      ...
      UpdateComplimentaryDescription: {
        route:
          "/maintenance-packages/{id}/set-complimentary-service-description",
        method: "patch",
      },
      UpdateComplimentaryOrder: {
        route:
          "/maintenance-packages/{id}/set-list-complimentary-service-order-index",
        method: "patch",
      },
      UpdateUpsellOrder: {
        route:
          "/maintenance-packages/{id}/set-list-interval-upsell-order-index",
        method: "patch",
      },
      UpdateSROrder: {
        route:
          "/maintenance-packages/{id}/set-list-service-request-order-index",
        method: "patch",
      },
      ...
      UpdatePriceTitles: {
        route: "/maintenance-packages/{id}/price-titles",
        method: "put",
      },
      UpdateSegmentTitles: {
        route: "/maintenance-packages/{id}/segment-titles",
        method: "put",
      },
    },
    Notifications: {
      GetAll: {
        route: "/appointment-notifications/{id}/configurations",
        method: "get",
      },
      UpdateForPod: {
        route: "/appointment-notifications/pods",
        method: "post",
      },
    ...
    OptimizationWindows: {
      ...
      GetOverbooking: {
        route: "/optimization-windows/overbooking-factor",
        method: "get",
      },
      SetOverbooking: {
        route: "/optimization-windows/overbooking-factor",
      ...
      GetAppointmentCutoff: {
        route: "/optimization-windows/appointment-cutoff",
        method: "get",
      },
    ...
    PricingSettings: {
      ...
      CreateTimeOfYear: {
        route: "/pricing-settings/time-of-year",
        method: "post",
      },
      GetTimeOfYear: { route: "/pricing-settings/time-of-year", method: "get" },
      UpdateTimeOfYear: {
        route: "/pricing-settings/time-of-year/{id}",
        method: "put",
      },
      RemoveTimeOfYear: {
        route: "/pricing-settings/time-of-year/{id}",
      ...
      ChangePackagePricingLevels: {
        route:
          "/pricing-settings/maintenance-package-options/pricing-levels/{id}",
        method: "put",
      },
    ...
    ServiceCategories: {
      ...
      GetShortByQuery: {
        route: "/service-categories/short-by-query",
        method: "post",
      },
    },
    ServiceCenters: {
      ...
      ChangePricingOpt: {
        route: "/service-centers/{id}/pricing-optimization",
        method: "patch",
      },
      GetSelection: { route: "/service-centers/selection", method: "get" },
      GetHOO: {
        route: "/service-centers/{id}/hours-of-operations",
        method: "get",
      },
      SetHOO: {
        route: "/service-centers/{id}/hours-of-operations",
      ...
      WorkingDays: {
        route: "/service-centers/{id}/working-days",
        method: "get",
      },
      GetRoundPrice: {
        route: "/service-centers/{id}/round-price",
        method: "get",
      },
      ChangeRoundPrice: {
        route: "/service-centers/{id}/round-price",
      ...
      GetReminders: {
        route: "/service-centers/{id}/send-reminders",
        method: "get",
      },
      UpdateReminders: {
        route: "/service-centers/{id}/send-reminders",
      ...
      GetLaborRate: {
        route: "/service-center-settings/{id}/labor-rates",
        method: "get",
      },
      UpdateLaborRate: {
        route: "/service-center-settings/{id}/labor-rates",
      ...
      SetEmailRequired: {
        route: "/service-center-settings/{id}/email-required",
        method: "patch",
      },
    },
    ServiceConsultants: {
      ...
      GetDmsAdvisors: {
        route: "/service-consultants/{id}/dms-service-advisors",
        method: "get",
      },
    ...
    ServiceRequests: {
      ...
      CreateOverrides: {
        route: "/service-requests/{id}/overrides",
        method: "post",
      },
      EditOverrides: {
        route: "/service-requests/overrides/{id}",
        method: "put",
      },
      GetSROverrides: {
        route: "/service-requests/overrides/{id}",
      ...
      GetAssignedOverrides: {
        route: "/service-requests/overrides",
        method: "get",
      },
      RemoveOverride: {
        route: "/service-requests/overrides/{id}",
      ...
      GetShort: {
        route: "/service-requests/overrides/short-by-query",
        method: "get",
      },
      EditSkills: {
        route: "/service-requests/required-skills",
        method: "patch",
      },
    ...
    SlotScoring: {
      ...
      SetOptimization: {
        route: "/slot-scoring/optimization-settings",
        method: "put",
      },
      GetOptimization: {
        route: "/slot-scoring/optimization-settings",
      ...
      SetValues: {
        route: "/slot-scoring/optimization-settings/values",
        method: "put",
      },
    ...
    ServiceValet: {
      GetZoneRouting: {
        route: "/service-valet/{id}/zone-routing",
        method: "get",
      },
      UpdateZoneRouting: {
        route: "/service-valet/{id}/zone-routing",
      ...
      GatAllCapacity: {
        route: "/service-valet/{id}/capacity/get-all",
        method: "get",
      },
      ...
      ChangeShowDropOffTime: {
        route: "service-valet/{id}/show-drop-off-time",
        method: "put",
      },
      ChangeServiceRequest: {
        route: "service-valet/{id}/service-request",
        method: "put",
      },
      ChangeDmsTimeStamp: {
        route: "service-valet/{id}/dms-time",
        method: "put",
      },
      GetServiceValetSettings: {
        route: "service-valet/{id}/settings",
        method: "get",
      },
    ...
    TransportationOptions: {
      ...
      GetShort: {
        route: "/transportation-options/short-by-query",
        method: "get",
      },
      GetActive: {
        route: "/transportation-options/active/by-query",
        method: "post",
      },
      Rules: { route: "/transportation-options/{id}/rules", method: "put" },
      UpdateById: { route: "/transportation-options/{id}", method: "put" },
      UpdateIcon: {
        route: "/transportation-options/{id}/icon",
        method: "patch",
      },
    },
    Users: {
    ...
    ValueService: {
      GetSeriesModels: {
        route: "/value-service-offers/vehicle-models",
        method: "get",
      },
  ...
  static async call<RValue = any>(r: TApiEndpoint, options?: TOptions) {
    ...
    if (r.method === "post" || r.method === "put" || r.method === "patch") {
      return request[r.method]<RValue, AxiosResponse<RValue>>(
        path,
        options?.data,
