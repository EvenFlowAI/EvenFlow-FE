...
export interface IApiEndpoints {
  ...
  Bays: Record<
    "Create" | "Update" | "Remove" | "Retrieve" | "GetAll" | "GetShort",
    TApiEndpoint
  >;
  BookingFlowConfig: Record<"Get" | "Update", TApiEndpoint>;
  BookingFlowScreenSettings: Record<
    "GetEmailRequirement" | "UpdateEmailRequirement",
    TApiEndpoint
  >;
  ...
  >;
  Holidays: Record<
    "Create" | "Update" | "Remove" | "Retrieve" | "GetAll",
    TApiEndpoint
  >;
  ...
  >;
  ServiceTypes: Record<
    "Create" | "UpdateIcon" | "Update" | "Remove" | "GetByQuery",
    TApiEndpoint
  >;
  SlotScoring: Record<
    | "SetProximity"
  ...
  >;
  ValueService: Record<
    "GetSeriesModels" | "GetValueServiceOffers",
    TApiEndpoint
  >;
