...
const App = () => {
  const { scProfile, isTopAligning } = useSelector(
  ...
  const [valueServiceNextScreen, setValueServiceNextScreen] = useState<TScreen>(
    "consultantSelection",
  );
  ...
  const onFocus = useCallback(() => {
    ...
    const isBefore = dayjs(lastLoadingTime)
      .utc()
  ...
  useEffect(() => {
    ...
    if (currentConfiguration)
      dispatch(setConfiguration(currentConfiguration, serviceTypeOption));
