...
const useGetConsultantsData = (serviceTypeOption: IFirstScreenOption|null, address?: any, zipCode?: string) => {
    const {
        selectedPackage,
        packagePricingType,
        packageEMenuType,
        ...
        subService,
        categoriesIds,
        appointmentByKey} = useSelector((state: RootState) => state.appointmentFrame);
