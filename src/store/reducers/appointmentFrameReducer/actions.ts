...
export const selectService = createAction<IServiceCategory | null>(
  "fAppointment/selectService",
);
export const selectSubService = createAction<IServiceCategory | null>(
  "fAppointment/selectSubService",
);
export const setFrameDescription = createAction<string>(
  "fAppointment/setFrameDescription",
);
export const setPackage = createAction<IPackageOptions | null>(
  "fAppointment/setPackage",
);
export const setPackagePricingType = createAction<EPackagePricingType | null>(
  "fAppointment/setPackagePricingType",
);
export const setAdvisor = createAction<IServiceConsultant | null>(
  "fAppointment/setAdvisor",
);
export const setAnyAdvisorSelected = createAction<boolean>(
  "fAppointment/setAnyAdvisorSelected",
);
export const setTiming = createAction<EAppointmentTimingType | null>(
  "fAppointment/setTiming",
);
export const setTime = createAction<TParsableDate>("fAppointment/setTime");
export const setVehicle = createAction<ILoadedVehicle | null>(
  "fAppointment/setVehicle",
);
export const updateVehicle = createAction<Partial<IVehicle>>(
  "fAppointment/updateVehicle",
);
export const setCustomer = createAction<ICustomer>("fAppointment/setCustomer");
export const setReminders = createAction<EReminderType[]>(
  "fAppointment/setReminders",
);
export const setAppointmentId = createAction<IAppointmentId>(
  "fAppointment/setAppointmentId",
);
...
export const setLoadingPackages = createAction<boolean>(
  "fAppointment/loadingPackages",
);
export const setPackages = createAction<IPackage[]>("fAppointment/setPackages");
export const setConsultants = createAction<IServiceConsultant[]>(
  "fAppointment/setConsultants",
);
export const setConsultantsLoading = createAction<boolean>(
  "fAppointment/setConsultantsLoading",
);
export const setCurrentFrameScreen = createAction<TScreen>(
  "fAppointment/setCurrentScreen",
);
...
export const setTrackerCreated = createAction<TTrackerState>(
  "fAppointment/SetTrackerCreated",
);
export const setAdditionalServicesChosen = createAction<boolean>(
  "fAppointment/SetAdditionalServicesChosen",
);
export const setPackageIsSelected = createAction<boolean>(
  "fAppointment/SetPackageIsSelected",
);
...
export const selectCategoriesIds = createAction<number[]>(
  "fAppointment/SelectCategoriesIds",
);
...
export const setPoliticalState = createAction<string>(
  "fAppointment/SetPoliticalState",
);
...
export const setValueService = createAction<IValueService | null>(
  "fAppointment/SetValueService",
);
export const getSeriesModels = createAction<TYear[]>(
  "fAppointment/GetSeriesModels",
);
...
export const setOffersLoading = createAction<boolean>(
  "fAppointment/SetOffersLoading",
);
export const setSideBarSteps = createAction<TScreen[]>(
  "fAppointment/SetSideBarSteps",
);
export const setSideBarMenu = createAction<string[]>(
  "fAppointment/SetSideBarMenu",
);
export const setSideBarActualSteps = createAction<{ [K in TScreen]: number }>(
  "fAppointment/SetSideBarMenuActualSteps",
);
export const setSideBarStepsList = createAction<TScreen[]>(
  "fAppointment/SetSideBarStepsList",
);
...
export const setWelcomeScreenView = createAction<TView>(
  "fAppointment/SetWelcomeScreenView",
);
export const switchLanguage = createAction<TLanguage>(
  "fAppointment/ChangeLanguage",
);
...
export const setFilteredZipCodes = createAction<string[]>(
  "fAppointment/SetFilteredZipCodes",
);
export const setSelectedRecalls = createAction<IRecallByVin[]>(
  "fAppointment/SetSelectedRecalls",
);
export const setRecallsAreShown = createAction<boolean>(
  "fAppointment/SetRecallsAreShown",
);
...
export const setAppointmentSaving = createAction<boolean>(
  "fAppointment/SetAppointmentSaving",
);
...
export const setCarIsValidForUpdate = createAction<boolean>(
  "fAppointment/SetCarIsValidForUpdate",
);
export const setUsualFlowNeeded = createAction<boolean>(
  "fAppointment/SetUsualFlowNeeded",
);
export const setEditingPosition = createAction<TEditingPosition | null>(
  "fAppointment/SetEditingPosition",
);
export const getAppointmentRequestsPrices = createAction<
  IServiceRequestPrice[]
>("fAppointment/GetAppointmentRequestsPrices");
export const setAppointmentNotes = createAction<string>(
  "fAppointment/SetAppointmentNotes",
);
export const setServiceOptionChanged = createAction<boolean>(
  "fAppointment/SetServiceOptionChanged",
);
export const getTransactionValue = createAction<number>(
  "fAppointment/GetTransactionValue",
);
export const setPassedScreens = createAction<TScreen[]>(
  "fAppointment/SetPassedScreens",
);
export const deleteLastScreen = createAction("fAppointment/DeleteLastScreen");
export const setConsentsLoading = createAction<boolean>(
  "fAppointment/SetConsentsLoading",
);
  ...
  (dispatch, getState) => {
    ...
    const data: IConsultantsRequestData = {
      ...
      serviceCategoryIds: serviceCategories
        ? serviceCategories.map((el) => el.id)
        : [],
    ...
    if (selectedVehicle) {
      if (
        ...
        const data: IConsultantsRequestData = {
          ...
          recalls,
          serviceCategoryIds: serviceCategories
            ? serviceCategories.map((item) => item.id)
            : [],
          maintenancePackageOption,
          serviceTypeOptionId,
          searchTerm: "",
...
export const loadMakes =
  ...
  async (dispatch) => {
    Api.call<IMake[]>(Api.endpoints.Vehicles.Makes, {
    ...
    Api.call(Api.endpoints.ZipCodes.GetFiltered, { data })
      .then((result) => {
        if (result?.data?.zipCodes)
          dispatch(setFilteredZipCodes(result.data.zipCodes));
...
export const setDefaultVisitCenterOption =
  (): AppThunk => (dispatch, getState) => {
    ...
    const firstVisitCenterOption = visitCenterOptions.find(
      (item) => item.orderIndex === minIndex,
    );
    const visitCenterWithoutTransport = visitCenterOptions.find(
      (item) => !item.transportationOption,
    );
    const visitCenterWithTransport = visitCenterOptions.find(
      (item) => item.transportationOption,
    );
    const defaultOption =
...
export const handleAppointmentResponse =
  ...
  (dispatch, getState) => {
    ...
    if (data.detailedPriceList)
      dispatch(getAppointmentRequestsPrices(data.detailedPriceList));
  ...
  (dispatch, getState) => {
    ...
    if (vehicle?.vin && scProfile && recalls?.length) {
      ...
      if (make && model && make && year) {
        dispatch(
          updateSelectedRecalls(scProfile.id, vin, make, model, year, recalls),
        );
      }
      const serviceType =
...
export const setVehicleDataFromValueService =
  (): AppThunk => (dispatch, getState) => {
    ...
    if (valueService && isBmWService) {
      ...
      if (bmwMake) {
        ...
        if (
          ...
          yearOptions.find(
            (option) => Number(option) === valueService?.year?.year,
          )
        ) {
          vehicle.year = Number(valueService.year.year);
        }
        const model = bmwMake.models.find(
          (model) => model === valueService.series?.name,
        );
...
export const clearAppointmentsWhileCreating =
  (): AppThunk => (dispatch, getState) => {
    const { customerLoadedData } = getState().appointment;
...
export const deleteIndService =
  ...
  (dispatch, getState) => {
    ...
    if (
      !indServiceCategory?.serviceRequests.find((request) =>
        services.includes(request.id),
      )
    ) {
      if (
        subService &&
        indServiceCategory &&
        subService?.id === indServiceCategory?.id
      )
        dispatch(selectSubService(null));
      if (
        service &&
        indServiceCategory &&
        service?.id === indServiceCategory?.id
      )
        dispatch(selectService(null));
    ...
    if (
      !diagnoseCategory?.serviceRequests.find((request) =>
        services.includes(request.id),
      )
    ) {
      if (
        subService &&
        diagnoseCategory &&
        subService?.id === diagnoseCategory?.id
      )
        dispatch(selectSubService(null));
...
export const deleteValueService = (): AppThunk => (dispatch, getState) => {
  ...
  if (service?.type === EServiceCategoryType.ValueService) {
    dispatch(selectService(null));
    dispatch(
      selectCategoriesIds(categoriesIds.filter((id) => id !== service?.id)),
    );
  }
  if (subService?.type === EServiceCategoryType.ValueService) {
    dispatch(selectSubService(null));
    dispatch(
      selectCategoriesIds(categoriesIds.filter((id) => id !== subService?.id)),
    );
  }
  ...
  (dispatch, getState) => {
    ...
    if (!recalls.length) {
      ...
      if (openRecallCategory) {
        ...
        if (openRecallCategory) {
          filteredCategories = categoriesIds.filter(
            (id) => id !== openRecallCategory?.id,
          );
...
export const handleSideBarAppointmentUpdate =
  (): AppThunk => (dispatch, getState) => {
    let steps: TScreen[] = [
      "carSelection",
      "location",
    ...
    if (!isAdvisorAvailable)
      steps = steps.filter((item) => item !== "consultantSelection");
    if (!isAppointmentTimingAvailable)
      steps = steps.filter((item) => item !== "appointmentTiming");
    if (!isTransportationAvailable)
      steps = steps.filter((item) => item !== "transportationNeeds");
...
export const createOrUpdateAppointment =
  ...
  (dispatch, getState) => {
    ...
    const driver: TDriverForRequest = {
      ...
      email: appointmentFrame.customer.email?.length
        ? appointmentFrame.customer.email
        : null,
    };
    ...
    const date =
      ...
      appointment.serviceValetAppointment
        ? dayjs
            .utc(appointment.serviceValetAppointment.date)
            .toISOString()
            .split("T")[0] || ""
    ...
    const maintenancePackageOption: TMaintenanceOption | null =
      appointmentFrame.selectedPackage
        ? {
    ...
    const isWaitlist =
      isVisitCenterAppointment &&
      (isWaitListSlotSelected || isWaitListManaging);
    ...
    const addressData: IAddressData = {
      ...
      originalFullAddress:
        appointmentFrame.address?.label ?? appointmentFrame.address ?? null,
    ...
    const data: ICreateAppointmentRequest = {
      ...
      customerId:
        appointment.customerLoadedData?.id ??
        appointmentFrame?.customer?.id ??
        null,
      ...
      address:
        appointmentFrame.serviceTypeOption?.type ===
...
export const checkCarIsValid =
  ...
  (dispatch, getState) => {
    ...
    if (selectedVehicle) {
      ...
      const existingEngineType = engineTypes.find(
        (item) => item.id === selectedVehicle.engineTypeId,
      );
      if (
        !skipEngineCheck &&
      ...
      if (
        !selectedVehicle.vin?.length &&
        selectedVehicle.make &&
        selectedVehicle.model
      ) {
        const existingMake = makes.find(
          (item) =>
            item.name.toLowerCase() === selectedVehicle.make.toLowerCase(),
        );
...
export const getCustomerConsentsBooking = createAction<
  ICustomerConsentBooking[]
>("fAppointment/GetCustomerConsentBooking");
export const setAcceptedConsentIds = createAction<number[]>(
  "fAppointment/SetAcceptedConsentIds",
);
...
export const searchForCustomerConsents =
  ...
  (dispatch, getState) => {
    ...
    if (scProfile && selectedVehicle) {
      ...
      const isWaitListSlotSelected =
        appointment?.isOverbookingApplied && settingsEnabled;
      const isWaitListManaging =
        !appointment &&
      ...
      Api.call<ICustomerConsentBooking[]>(
        Api.endpoints.CustomerConsent.Search,
        { data },
      )
        .then((res) => {
          if (res?.data?.length) {
            const filtered = res.data.filter(
              (el) => !acceptedConsentIds.includes(el.id),
            );
    ...
    if (currentAppointment) {
      ...
      const date =
        currentAppointment?.serviceTypeOption?.type ===
          EServiceType.PickUpDropOff && appointment.serviceValetAppointment
          ? dayjs
              .utc(appointment.serviceValetAppointment.date)
              .toISOString()
              .split("T")[0] || ""
      ...
      const transportationOptionId =
        currentAppointment?.transportationOption?.id ?? null;
      const serviceRequests = currentAppointment?.serviceRequests
        ? currentAppointment?.serviceRequests.map((el) => ({
            id: el.id,
            comment: null,
          }))
        : [];
      const maintenancePackageOption =
        currentAppointment.maintenancePackageOption
          ? {
              id: currentAppointment.maintenancePackageOption.id,
              priceType:
                currentAppointment.maintenancePackageOption.priceType ?? null,
            }
          : null;
      ...
      const isVisitCenterAppointment =
        currentAppointment?.serviceTypeOption?.type ===
          EServiceType.VisitCenter || !currentAppointment.serviceTypeOption;

      const isWaitlist = isVisitCenterAppointment && isWaitListSlotSelected;

      const advisor = consultants.find(
        (el) => el.id === currentAppointment?.advisor?.id,
      );
      ...
      const data: ICreateAppointmentRequest = {
        ...
        advisor: {
          id:
            ...
            !currentAppointment.advisor?.isAnySelected &&
            advisor
              ? advisor?.id
              : null,
          isAnySelected: advisor
            ? Boolean(currentAppointment.advisor?.isAnySelected)
            : true,
        },
        transportationOptionId,
        slot,
...
export const goToSlotsSelection =
  ...
  (dispatch, getState) => {
    ...
    if (prevOption) {
      const prevConfig = config.find(
        (el) => el.serviceType === prevOption.type,
      );
      ...
      API.appointment
        ...
        .then(({ data }) => {
          if (data) {
            ...
            const option = firstScreenOptions.find(
            ...
            dispatch(
              setAnyAdvisorSelected(data.advisor?.isAnySelected ?? true),
            );
