...
export const serviceRequestsReducer = createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(setNonSelectedPageData, (state, { payload }) => {
      return {
        ...state,
        nonSelectedPageData: { ...state.nonSelectedPageData, ...payload },
      };
    })
    .addCase(setNonSelectedFilter, (state, { payload }) => {
      return {
        ...state,
        nonSelectedFilter: { ...state.nonSelectedFilter, ...payload },
      };
    })
    ...
    .addCase(setAssignedPageData, (state, { payload }) => {
      return {
        ...state,
        assignedPageData: { ...state.assignedPageData, ...payload },
      };
    })
    .addCase(setAssignedFilter, (state, { payload }) => {
      return {
        ...state,
        assignedFilter: { ...state.assignedFilter, ...payload },
      };
    })
    ...
    .addCase(setPageDataUrgentServiceRequests, (state, { payload }) => {
      return {
        ...state,
        urgentPageData: { ...state.urgentPageData, ...payload },
      };
    })
    ...
    .addCase(setPageDataNonUrgentServiceRequests, (state, { payload }) => {
      return {
        ...state,
        nonUrgentPageData: { ...state.nonUrgentPageData, ...payload },
      };
    })
    ...
    .addCase(setUpsellPageData, (state, { payload }) => {
      return {
        ...state,
        upsellPageData: { ...state.upsellPageData, ...payload },
      };
    }),
);
