...
export type TLoadingTechnicians = {
  type: "Employees/LoadingTechnicians";
  payload: boolean;
};
export type TGetTechnicians = {
  type: "Employees/GetTechnicians";
  payload: IEmployee[];
};
export type TChangeFilters = {
  type: "Employees/ChangeFilters";
  payload: IEmployeeFilters;
};
...
export type TChangePageData =
  TChangePageDataGeneric<"Employees/ChangePageData">;
export type TLoadingDMSAdvisors = {
  type: "SCEmployees/LoadingDMSAdvisors";
  payload: boolean;
};
export type TGetUsersShort = {
  type: "Employees/GetUsersShort";
  payload: IAdvisorShort[];
};
export type TGetBaseSummary = {
  type: "Employees/GetBaseSummary";
  payload: IBaseSummary;
};
export type TGetBaseScheduleByEmployee = {
  type: "Employees/GetBaseScheduleByEmployee";
  payload: IEmployeeRoleHours[];
};
export type TGetScheduleTimeByEmployee = {
  type: "Employees/GetScheduleTimeByEmployee";
  payload: IEmployeeSchedule;
};
...
export type TGetAssignmentSettings = {
  type: "Employees/GetAssignmentSettings";
