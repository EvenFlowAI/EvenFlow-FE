...
export type TGetShort = {
  type: "ServiceCenters/GetShort";
  payload: IServiceCenter[];
};
export type TShortLoading = {
  type: "ServiceCenters/ShortLoading";
  payload: boolean;
};
export type TCreate = {
  type: "ServiceCenters/Create";
  payload: IServiceCenterExtended;
};
export type TLoading = { type: "ServiceCenters/Loading"; payload: boolean };
export type TDealershipLoading = {
  type: "ServiceCenters/DealershipLoading";
  payload: boolean;
};
export type TSaving = { type: "ServiceCenters/Saving"; payload: boolean };
export type TSelectSC = {
  type: "ServiceCenters/SelectSC";
  payload: IServiceCenter | undefined;
};
export type TFullSCList = {
  type: "ServiceCenters/FullSCList";
  payload: IServiceCenter[];
};
export type TChangePageData =
  TChangePageDataGeneric<"ServiceCenters/ChangePageData">;
export type TChangePaging = TChangePagingGeneric<"ServiceCenters/ChangePaging">;
export type TChangeDealershipPaging =
  TChangePagingGeneric<"ServiceCenters/ChangeDealershipPaging">;
export type TSetDealerShipId = {
  type: "ServiceCenters/SetDealershipId";
  payload: number | undefined;
};
export type TSetReminders = {
  type: "ServiceCenters/SetReminders";
  payload: boolean;
};
export type TSetRemindersLoading = {
  type: "ServiceCenters/SetRemindersLoading";
  payload: boolean;
};
...
export type TSetLaborRate = {
  type: "ServiceCenters/SetLaborRate";
  payload: ILaborRate;
};
