...
const getAll = (payload: IServiceCenterExtended[]): TServiceCenterActions => ({
  type: "ServiceCenters/GetAll",
  payload,
});

export const loading = (payload: boolean): TServiceCenterActions => ({
  type: "ServiceCenters/Loading",
  payload,
});
export const packageOptionsLoading = (
  payload: boolean,
): TServiceCenterActions => ({
...
export const saving = (payload: boolean): TServiceCenterActions => ({
  type: "ServiceCenters/Saving",
  payload,
});

export const setSelectedDealershipGroupId = (
...
export const saveAvatar =
  (avatar: File, id: number): AppThunk =>
  async () => {
    try {
  ...
  async (dispatch) => {
    ...
    try {
      const { data } = await Api.call<IServiceCenterExtended>(
        Api.endpoints.ServiceCenters.Create,
        { data: payload },
      );
      if (avatar) {
...
const shortLoading = (payload: boolean): TServiceCenterActions => ({
  type: "ServiceCenters/ShortLoading",
  payload,
});
const _loadShortSC = (payload: IServiceCenter[]): TServiceCenterActions => ({
  type: "ServiceCenters/GetShort",
  payload,
});
export const loadShortSC: ActionCreator<
  ThunkAction<void, RootState, void, TServiceCenterActions>
> =
  (isAdminPanel: boolean, dealershipId?: number) =>
  async (dispatch, getState) => {
...
export const removeSC: ActionCreator<AppThunk> =
  (serviceCenterId: number, onSuccess: TCallback, onError: TArgCallback<any>) =>
  async (dispatch) => {
    try {
      await Api.call(Api.endpoints.ServiceCenters.Remove, {
...
const loadingDealership = (payload: boolean): TServiceCenterActions => ({
  type: "ServiceCenters/DealershipLoading",
  payload,
});
const pagingDealership = changePagingGeneric(
  "ServiceCenters/ChangeDealershipPaging",
);
const _loadDealershipSCs = (
  payload: IServiceCenterExtended[],
): TServiceCenterActions => ({
  type: "ServiceCenters/GetDealershipAll",
  payload,
});
export const loadDealershipSCs =
  (dealershipId: string, pageData: IPageRequest): AppThunk =>
  async (dispatch) => {
...
const _loadAllSCS = (payload: IServiceCenter[]): TServiceCenterActions => ({
  type: "ServiceCenters/FullSCList",
  payload,
});
const _selectSc = (
  payload: IServiceCenter | undefined,
): TServiceCenterActions => {
  return { type: "ServiceCenters/SelectSC", payload };
};
export const selectSC =
  (payload: IServiceCenter): AppThunk =>
  (dispatch) => {
...
export const getWorkingDays = createAction<EDay[]>(
  "ServiceCenters/WorkingDays",
);
...
export const setPricingOpt = createAction<{ id: number; checked: boolean }>(
  "ServiceCenters/ApplyPricingOpt",
);
export const changePricingOpt =
  (id: number, applyPricingOptimization: boolean): AppThunk =>
  async (dispatch) => {
    try {
      await Api.call(Api.endpoints.ServiceCenters.ChangePricingOpt, {
        urlParams: { id },
        data: { applyPricingOptimization },
      });
...
export const setReminders = createAction<boolean>(
  "ServiceCenters/SetReminders",
);
export const setRemindersLoading = createAction<boolean>(
  "ServiceCenters/RemindersLoading",
);
...
export const updateReminders =
  ...
  (dispatch) => {
    dispatch(setRemindersLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateReminders, {
      urlParams: { id },
      data: { isSendReminders },
    })
      .then((result) => {
        if (result) {
...
export const updateAuth =
  ...
  (dispatch) => {
    dispatch(setRemindersLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateAuth, {
      urlParams: { id },
      data: { isAuthRequired },
    })
      .then((result) => {
...
export const updateAdvisor =
  ...
  (dispatch) => {
    dispatch(setRemindersLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateAdvisor, {
      urlParams: { id },
      data: { isUpdateAdvisorInAppointments },
    })
      .then((res) => {
        if (res) {
          onSuccess();
...
export const setParamsLoading = createAction<boolean>(
  "ServiceCenters/SetParamsLoading",
);
export const setPredictionParams = createAction<IPredictionParams>(
  "ServiceCenters/SetPredictionParams",
);
export const loadPredictionParams =
  (id: number, podId?: number): AppThunk =>
  (dispatch) => {
...
export const updatePredictionParams =
  (
    id: number,
    data: IPredictionParams,
    onError: (err: string) => void,
    onSuccess: () => void,
  ): AppThunk =>
  (dispatch) => {
    dispatch(setParamsLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdatePredictionParams, {
      urlParams: { id },
      data,
    })
      .then((result) => {
...
export const setLaborRate = createAction<ILaborRate>(
  "ServiceCenters/SetLaborRate",
);
export const loadLaborRate =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setParamsLoading(true));
...
export const updateLaborRate =
  ...
  (dispatch) => {
    dispatch(setParamsLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateLaborRate, {
      urlParams: { id },
      data,
    })
      .then((result) => {
...
export const updatePackageDisclaimer =
  (
    id: number,
  ...
  (dispatch) => {
    Api.call(Api.endpoints.ServiceCenters.UpdatePackageDisclaimer, {
      urlParams: { id },
      data: { maintenancePackageDisclaimer },
    })
      .then((result) => {
        if (result) {
          dispatch(loadAllSCs());
...
export const updatePackagePriceDetails =
  (
    id: number,
  ...
  (dispatch) => {
    dispatch(loading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdatePackagePriceDetails, {
      urlParams: { id },
      data: { isShowPriceDetails },
    })
      .then((result) => {
...
export const updateDefaultRecallOpsCode =
  ...
  (dispatch) => {
    dispatch(loading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateDefaultOpsCode, {
      urlParams: { id },
...
export const updateDefaultMake =
  (
    id: number,
  ...
  (dispatch) => {
    dispatch(loading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateDefaultMake, {
      urlParams: { id },
      data: { defaultVehicleMakeId },
    })
      .then((result) => {
        if (result) dispatch(loadAllSCs());
      })
...
export const updateAvailablePackageOptions =
  (
    id: number,
    data: EMaintenanceOptionType[],
    onError: (err: string) => void,
  ): AppThunk =>
  (dispatch) => {
    dispatch(packageOptionsLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdatePresentedPackageOptions, {
      urlParams: { id },
...
export const getAdvisorAssignment = createAction<IAdvisorAssignment>(
  "ServiceCenters/GetAdvisorAssignment",
);
export const setAdvisorAssignmentLoading = createAction<boolean>(
  "ServiceCenters/SetAdvisorAssignmentLoading",
);

export const loadAdvisorAssignment =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setAdvisorAssignmentLoading(true));
    Api.call(Api.endpoints.ServiceCenters.GetAssignedAdvisorMethod, {
      urlParams: { id },
    })
      .then((result) => {
...
export const updateAdvisorAssignment =
  (
    id: number,
    data: IAdvisorAssignment,
    onSuccess: () => void,
    onError: (err: string) => void,
  ): AppThunk =>
  (dispatch) => {
    dispatch(setAdvisorAssignmentLoading(true));
    Api.call(Api.endpoints.ServiceCenters.UpdateAssignedAdvisorMethod, {
      urlParams: { id },
      data,
    })
      .then((result) => {
