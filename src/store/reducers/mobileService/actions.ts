...
export const setCurrentZone = createAction<TZone | null>(
  "MobileService/SetCurrentZone",
);
...
export const setMobileServicePrisingByZones = createAction<
  IZonePriceSettings[]
>("MobileService/SetPrisingSettingsByZones");
export const setMobileServicePrisingByDistance = createAction<
  IDistancePriceSettings[]
>("MobileService/SetPrisingSettingsByDistance");
export const setMobileServicePrisingOption = createAction<EAncillaryPriceType>(
  "MobileService/SetMobileServicePrisingOption",
);
export const setPricingOptionLoading = createAction<boolean>(
  "MobileService/SetPricingOptionLoading",
);
export const setMobileZonesShort = createAction<TGeographicZone[]>(
  "MobileService/SetZonesShort",
);
...
export const getMobileZoneById =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
...
export const addMobServiceZone =
  (
    id: number,
    data: TZoneNew,
    onSuccess: () => void,
  ...
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.GeographicZones.Create, {
      data: { ...data, serviceType: EServiceType.MobileService },
    })
      .then((result) => {
        if (result) {
...
export const removeMobServiceZone =
  (
    id: number,
...
export const updateMobServiceZone =
  (
    id: number,
    serviceCenterId: number,
    data: TZoneUpdate,
...
export const removeZipFromMobServiceZone =
  (id: number, zip: TZipCode): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.GeographicZones.RemoveZipCode, {
      urlParams: { id: zip.id },
    })
      .then((result) => {
...
export const assignZipToMobServiceZone =
  (
    id: number,
    serviceCenterId: number,
    data: TReassignZip,
  ...
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.GeographicZones.ReassignZipCode, {
...
export const loadMobileServicePrisingByZones =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    const data = {
    ...
    Api.call(Api.endpoints.AncillaryPricing.GetZones, { data })
      .then((result) => {
        if (result?.data?.result)
          dispatch(setMobileServicePrisingByZones(result.data.result));
      })
      .catch((err) => {
        console.log(
          "get ancillary pricing by geographic zones for Mobile Service error",
          err,
        );
      })
      .finally(() => {
...
export const loadMobileServicePrisingByDistance =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    const data = {
    ...
    Api.call(Api.endpoints.AncillaryPricing.GetDistances, { data })
      .then(({ data }) => {
        if (data?.result)
          dispatch(setMobileServicePrisingByDistance(data.result));
      })
      .catch((err) => {
...
export const updateMobileServicePrisingByZones =
  (
    serviceCenterId: number,
    id: number,
    data: IZonePricingUpdate,
    onError: (err: string) => void,
  ): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.AncillaryPricing.UpdateZone, {
      urlParams: { id },
      data,
    })
      .then((result) => {
      ...
      .catch((err) => {
        onError(err);
        console.log(
          "update ancillary pricing by zone for mobile service error",
          err,
        );
      })
      .finally(() => dispatch(setLoading(false)));
...
export const updateMobileServicePrisingByDistance =
  (
    serviceCenterId: number,
    id: number,
    data: TDistanceRangeUpdate,
    onError: (err: string) => void,
  ): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.AncillaryPricing.UpdateDistance, {
      urlParams: { id },
      data,
    })
      .then((result) => {
        if (result)
          dispatch(loadMobileServicePrisingByDistance(serviceCenterId));
      })
      .catch((err) => {
        dispatch(setLoading(false));
        onError(err);
...
export const deleteMobileServicePrisingByDistance =
  (id: number, pricingId: number, onError: (err: string) => void): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.AncillaryPricing.DeleteDistance, {
      urlParams: { id: pricingId },
    })
      .then((result) => {
...
export const addMobileServiceDistanceRange =
  (
    id: number,
    data: TDistanceRange,
    onSuccess: () => void,
...
export const loadMobileServicePricingOption =
  (id: number): AppThunk =>
  (dispatch) => {
    ...
    Api.call(Api.endpoints.ServiceCenters.GetAncillaryPriceType, {
      urlParams: { id },
      data,
    })
      .then((result) => {
        if (result && Number.isInteger(result.data))
          dispatch(setMobileServicePrisingOption(result.data));
      })
      .catch((err) => {
...
export const changeMobileServicePriceSettings =
  (
    id: number,
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.ServiceCenters.UpdateAncillaryPriceType, {
      urlParams: { id },
      data,
    })
      .then((result) => {
...
export const loadZonesShortMobile =
  ...
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call<TGeographicZone[]>(Api.endpoints.GeographicZones.GetShort, {
      params: {
        serviceType: EServiceType.MobileService,
        serviceCenterId,
        podId,
