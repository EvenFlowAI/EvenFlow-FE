...
export const loadingDemandSegments = createAction<boolean>(
  "DemandSegments/Loading",
);
export const getDemandSegments = createAction<IDemandSegment[]>(
  "DemandSegments/GetDemandSegments",
);
...
export const createDemandSegment =
  ...
  async (dispatch) => {
    try {
      await Api.call(Api.endpoints.AppointmentAllocation.CreateDemandSegment, {
        data,
      });
...
export const setDemandSegments =
  ...
  async (dispatch) => {
    try {
      await Api.call(
        Api.endpoints.AppointmentAllocation.BatchUpdateDemandSegments,
        { data },
      );
      dispatch(loadDemandSegments(data.serviceCenterId, data.podId));
    } catch (err) {
...
export const getTimeWindow = createAction<ITimeWindow>(
  "DemandSegments/GetTimeWindows",
);
export const setTimeWindowsLoading = createAction<boolean>(
  "DemandSegments/SetTimeWindowsLoading",
);
...
export const setTimeWindow =
  ...
  async (dispatch) => {
    try {
      await Api.call(Api.endpoints.AppointmentAllocation.SetTimeWindows, {
        data,
      });
...
export const setUnplannedLoading = createAction<boolean>(
  "DemandSegments/SetUnplannedLoading",
);
...
export const loadUnplannedSlots =
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.AppointmentAllocation.GetUnplannedSlotsByDay, {
      params: { ...data },
    })
      .then((res) => {
...
export const setRecalculationLoading = createAction<boolean>(
  "DemandSegments/RecalculationLoading",
);
export const recalculateCapacity =
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.CapacityManagement.Reallocate, {
