...
export const getCustomers = createAction<ICustomerWithPhones[]>(
...
export const loadCustomersBySearchTerm =
  ...
  (dispatch) => {
    ...
    if (Object.keys(data).length) {
      ...
      Api.call<PaginatedAPIResponse<ICustomerWithPhones>>(
        Api.endpoints.Customers.GetBySearchTerm,
