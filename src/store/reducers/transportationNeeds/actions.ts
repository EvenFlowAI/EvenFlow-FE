...
export const setTransportationLoading = createAction<boolean>(
  "TransportationNeeds/SetLoading",
);
export const getTransportationOptions = createAction<
  ITransportationOptionFull[]
>("TransportationNeeds/GetOptions");
export const getTransportationOptionsShort = createAction<
  TTransportationShort[]
...
export const loadTransportationOptions =
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.TransportationOptions.Get, {
...
export const editTransportationOptionRules =
  ...
  (dispatch) => {
    Api.call(Api.endpoints.TransportationOptions.Rules, {
...
export const updateTransportationDescription =
  ...
  (dispatch) => {
    Api.call(Api.endpoints.TransportationOptions.UpdateById, {
      urlParams: { id: optionId },
      data,
    })
      .then((result) => {
...
export const loadTransportationOptionsShort =
  ...
  (dispatch) => {
    dispatch(setTransportationLoading(true));
    Api.call(Api.endpoints.TransportationOptions.GetShort, {
...
export const updateTransportationIcon =
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.TransportationOptions.UpdateIcon, {
      urlParams: { id },
      data,
    })
      .then((result) => {
