...
export type TOpenConfirmModal = {
  type: "Modals/OpenConfirm";
  payload: TConfirmModalPayload;
};
export type TCloseConfirmModal = { type: "Modals/CloseConfirm" };
export type TSetChangesModal = {
  type: "Modals/SetOpenChanges";
  payload: boolean;
};
export type TSetSlotsWarningModal = {
  type: "Modals/SetSlotsWarning";
  payload: boolean;
};
export type TSetServiceWarningModal = {
  type: "Modals/SetServiceWarning";
  payload: boolean;
};
export type TOpenUnavailableService = {
  type: "Modals/OpenUnavailableService";
  payload: boolean;
};
export type TOpenConsent = { type: "Modals/OpenConsent"; payload: boolean };
export type TSlotsWarningShowed = {
  type: "Modals/SlotsWarningShowed";
  payload: boolean;
};
