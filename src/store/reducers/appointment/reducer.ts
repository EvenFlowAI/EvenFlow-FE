...
export const appointmentReducer = createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(changePersonalInformation, (state, { payload }) => {
      return {
        ...state,
        personalInformation: { ...state.personalInformation, ...payload },
      };
    })
    ...
    .addCase(setAppointmentFilters, (state, { payload }) => {
      return {
        ...state,
        appointmentFilters: { ...state.appointmentFilters, ...payload },
      };
    })
      ...
      if (payload) {
        return {
          ...
          personalInformation: {
            ...
            email: payload.emails?.length
              ? payload.emails[0]
              : state.customerEnteredEmail,
            phoneNumber: payload.phoneNumbers?.length
              ? payload.phoneNumbers[0]
              : "",
          },
        };
      }
