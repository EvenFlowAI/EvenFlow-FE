...
export const setPodsPageData =
  createAction<Partial<IPageRequest>>("Pods/PageData");
export const setPodsPaging = createAction<IPagingResponse>("Pods/Paging");
export const setPodsFilters =
  createAction<Partial<IPodFilters>>("Pods/Filters");
export const getPodsShort = createAction<IPodShort[]>("Pods/GetPodsShort");
export const setSelectedPod = createAction<IPodShort | null>(
  "Pods/SetSelectedPod",
);
export const setPodById = createAction<IPod | null>("Pods/SetPodById");
export const setPodsSummary = createAction<IPodSummary[]>(
  "Pods/SetPodsSummary",
);
...
export const loadPods =
  ...
  async (dispatch, getState) => {
    ...
    try {
      const {
        data: { result, paging },
      } = await Api.call<PaginatedAPIResponse<IPod>>(
...
export const loadPodsShort =
  ...
  async (dispatch) => {
    try {
      const {
        data: { result },
      } = await Api.call<PaginatedAPIResponse<IPodShort>>(
...
export const loadPodsSummary =
  ...
  (dispatch) => {
    dispatch(setPodsLoading(true));
    Api.call<IPodSummary[]>(Api.endpoints.Pods.GetSummary, {
...
export const setPodsOrderIndex =
  ...
  (dispatch) => {
    dispatch(setPodsLoading(true));
    Api.call<IPodSummary[]>(Api.endpoints.Pods.SetOrderIndex, {
