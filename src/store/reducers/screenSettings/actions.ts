...
export const getEmailRequirement = createAction<TEmailRequirement>(
  "ScreenSettings/getEmailRequirement",
);
export const setEmailRequirementLoading = createAction<boolean>(
  "ScreenSettings/SetEmailRequirementLoading",
);
export const setConsentLoading = createAction<boolean>(
  "ScreenSettings/SetConsentLoading",
);
export const setLoading = createAction<boolean>("ScreenSettings/SetLoading");
export const setConsentsList = createAction<ICustomerConsent[]>(
  "ScreenSettings/SetConsentsList",
);
export const getCurrentConsent = createAction<ICustomerConsentById | null>(
  "ScreenSettings/SetConsentById",
);

export const loadConsentsList =
  (serviceCenterId: number, podId?: number | null): AppThunk =>
  (dispatch) => {
    dispatch(setConsentLoading(true));
    Api.call<ICustomerConsent[]>(Api.endpoints.CustomerConsent.GetAll, {
...
export const loadConsentById =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setConsentLoading(true));
    Api.call<ICustomerConsentById>(Api.endpoints.CustomerConsent.GetById, {
      urlParams: { id },
    })
      .then((result) => {
        if (result) {
...
export const loadEmailRequirement =
  (id: number): AppThunk =>
  (dispatch) => {
    dispatch(setEmailRequirementLoading(true));
    Api.call<TEmailRequirement>(
      Api.endpoints.BookingFlowScreenSettings.GetEmailRequirement,
      { urlParams: { id } },
    )
      .then((res) => {
...
export const updateEmailRequirement =
  (
    serviceCenterId: number,
    data: TEmailRequirement,
  ...
  (dispatch) => {
    ...
    Api.call(Api.endpoints.BookingFlowScreenSettings.UpdateEmailRequirement, {
...
export const loadZonesByServiceType =
  (
    serviceCenterId: number,
  ...
  (dispatch) => {
    ...
    Api.call<TGeographicZone[]>(Api.endpoints.GeographicZones.GetShort, {
      params: { serviceType, serviceCenterId, podId },
    })
      .then((res) => {
        if (res?.data) {
...
export const updateCustomerConsent =
  (
    data: ICustomerConsentById,
    onError: TArgCallback<any>,
    onSuccess: TCallback,
  ): AppThunk =>
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.CustomerConsent.Update, {
      data,
...
export const removeCustomerConsent =
  ...
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.CustomerConsent.Remove, {
      params: { id, serviceCenterId },
    })
      .then((res) => {
...
export const toggleCustomerConsent =
  ...
  (dispatch) => {
    dispatch(setLoading(true));
    Api.call(Api.endpoints.CustomerConsent.Toggle, {
      data: { serviceCenterId, id, isEnabled },
    })
      .then((res) => {
        if (res) dispatch(loadConsentsList(serviceCenterId, podId));
      })
