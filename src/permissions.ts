...
export const PERMISSIONS: TRouteRoleMap[] = [
  ...
  { route: Routes.Admin.Application, roles: ["Super Admin"] },
  {
    ...
    roles: ["Manager", "Owner", "Service Director"],
  },
  {
    route: Routes.Employees.AddDelete,
    roles: ["Manager", "Owner", "Service Director"],
  },
  ...
  {
    route: Routes.Admin.ServiceRequests,
  ...
  {
    route: Routes.CapacityManagement.AppointmentAllocation,
    roles: ["Owner", "Manager", "Service Director"],
  },
  {
  ...
  {
    route: Routes.Services.VehicleServices,
    roles: ["Owner", "Manager", "Service Director"],
  },
  {
    route: Routes.Services.ServiceValet,
    roles: ["Owner", "Manager", "Service Director"],
  },
  {
  ...
  {
    route: Routes.OfferManagement.Base,
    roles: ["Owner", "Manager", "Service Director"],
  },
