...
export const AdminRoutes = () => {
  ...
  const currentRoleIsRestricted =
    !!currentUser &&
    ["Call Center Rep", "Advisor", "Technician"].includes(currentUser?.role);
    ...
    <ContentContainer>
      <Switch>
        {currentUser.isSuperUser ? (
          <PrivateRoute
            path={Routes.Admin.DealershipGroups}
            exact
            component={DealershipGroups}
          />
        ) : null}
        {currentUser.isSuperUser ? (
          <PrivateRoute
        ...
        {currentUser.isSuperUser ? (
          <PrivateRoute
            path={Routes.Admin.ServiceCenters}
            exact
        ...
        {!currentRoleIsRestricted && (
          <PrivateRoute
            path={Routes.Employees.Base}
            component={EmployeesRoutes}
          />
        )}
        {!currentUser.isSuperUser ? (
          <PrivateRoute
            path={Routes.CenterProfile.Base}
            component={CenterProfileRoutes}
          />
        ) : null}
        {!currentUser.isSuperUser ? (
          <PrivateRoute
