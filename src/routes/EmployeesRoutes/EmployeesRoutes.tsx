...
const EmployeesRoutes = () => {
  return (
    <ContentContainer>
      <Switch>
        <PrivateRoute
          path={Routes.Employees.AddDelete}
          component={EmployeesAddDelete}
        />
        <PrivateRoute
          path={Routes.Employees.ScheduleSetUp}
          component={EmployeesScheduleSetUp}
        />
        <PrivateRoute
          path={Routes.Employees.ScheduleManagement}
          component={EmployeesScheduleManagement}
        />
        <PrivateRoute
          path={Routes.Employees.EmployeeCapacity}
