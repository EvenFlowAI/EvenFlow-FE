...
import {
    MobileServiceAppointments
} from "../../features/admin/Reporting/MobileServiceAppointments/MobileServiceAppointments";
...
import {
    CapacityManagementPerformance
} from "../../features/admin/Reporting/CapacityManagementPerfomance/CapacityManagementPerfomance";
import {useCurrentUser} from "../../hooks/useCurrentUser/useCurrentUser";
import {Routes} from "../constants";

export const ReportingRoutes: React.FC<React.PropsWithChildren<React.PropsWithChildren<{ config: IEndUserConfig }>>> = ({config}) => {
