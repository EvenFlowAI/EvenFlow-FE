...
export const BookingFlowSettingsRoutes = () => {
  return (
    <ContentContainer>
      <Switch>
        <PrivateRoute
          path={Routes.BookingFlow.ServiceOpsCodesMapping}
          component={ServiceCategoriesPage}
        />
        <PrivateRoute
          path={Routes.BookingFlow.BookingFlowConfigDetails}
          component={BookingFlowConfigPage}
        />
        <PrivateRoute
          path={Routes.BookingFlow.FirstScreen}
          component={FirstScreenOptionsPage}
        />
        <PrivateRoute
          path={Routes.BookingFlow.ScreenSettings}
