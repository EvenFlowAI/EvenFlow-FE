...
const AppRoutes: React.FC<React.PropsWithChildren<React.PropsWithChildren<TProps>>> = ({
  valueServicePreviousScreen,
  valueServiceNextScreen,
}) => {
  ...
  return (
    <Switch>
      ...
      <Route
        ...
        exact
        render={() => (
          <ValueService onBack={onValueServiceBack} nextScreen={valueServiceNextScreen} />
        )}
      />
