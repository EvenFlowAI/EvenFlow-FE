...
> = ({ valueServicePreviousScreen, valueServiceNextScreen }) => {
  const { trackerData, serviceTypeOption } = useSelector(
  ...
  useEffect(() => {
    if (currentConfig && serviceTypeOption?.transportationOption)
  ...
  return (
    <Switch>
      <Route
        path={Routes.EndUser.AppointmentFrame}
        exact
        component={AppointmentFlow}
      />
      <Route path={"/welcome/fallback-example"} exact component={FallBack} />
      <Route
        path={Routes.EndUser.ManageAppointmentFrame}
        exact
        component={AppointmentFlow}
      />
      <Route
        path={Routes.EndUser.CancelAppointment}
        exact
        component={BookingFlow}
      />
      <Route
        path={Routes.EndUser.CancelAppointmentFromEmail}
        exact
        component={BookingFlow}
      />
      <Route
        path={Routes.EndUser.EditAppointment}
        exact
        component={BookingFlow}
      />
      <Route
        path={Routes.EndUser.EditAppointmentFromEmail}
        exact
        component={BookingFlow}
      />
      ...
      <Route
        ...
        render={() => (
          <ValueService
            onBack={onValueServiceBack}
            nextScreen={valueServiceNextScreen}
          />
        )}
      />
